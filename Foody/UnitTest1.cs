...
namespace Foody
{
    ...
    public class FoodyTests
    {
        ...
        public void Setup()
        {
            string token = GetJwtToken("Jorkata", "joroistesting123");
        ...
        [Test, Order(1)]
        public void CreateNewFoodWithTheRequiredFields()
        {
            var food = new
            {
                Name = "New Created Food",
                Description = "Test New Food",
                Url = ""
            };
        ...
        [Test, Order(2)]
        public void EditTheTitleOfTheFoodThatYouCreated()
        {
            var changes = new[]
            {
        ...
        [Test, Order(5)]
        public void CreateFoodWithoutTheRequiredFields()
        {
            var food = new
            {
                Name = "",
